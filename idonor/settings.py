"""
Django settings for idonor project.
...
WSGI_APPLICATION = 'idonor.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(STATIC_ROOT, 'donor'),
    os.path.join(STATIC_ROOT, 'institution')
]
